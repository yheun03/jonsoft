    ...
    <section ref="root" class="legacy-section-root">
        <div class="banner set-bg-bottom">
            <div class="module-text">
                <div class="wrap">
                    <p class="title-sub"><span class="gradient-text" data-aos="fade-up" data-aos-delay="200"
                            v-html="t('about.banner.title-sub')"></span></p>
        ...
        <div class="module-text">
            <div class="wrap">
                <p class="title-sub" data-aos="fade-up" data-aos-delay="800"><span class="gradient-text"
                        v-html="t('about.module-text.overview.title-sub')"></span></p>
                <p class="title" data-aos="fade-up" data-aos-delay="1000"
                    v-html="t('about.module-text.overview.title')"></p>
                <p class="dscpt" data-aos="fade-up" data-aos-delay="1200"
                    v-html="t('about.module-text.overview.dscpt')"></p>
            </div>
        </div>
        <div class="summary">
            <div class="wrap">
        ...
        <div class="module-text">
            <div class="wrap">
                <p class="title-sub"><span class="gradient-text" data-aos="fade-up" data-aos-delay="200"
                        v-html="t('about.module-text.feature.title')"></span></p>
                <p class="title" data-aos="fade-up" data-aos-delay="400" v-html="t('about.module-text.feature.dscpt')">
                </p>
            </div>
        </div>
        <div class="feature">
            <div class="wrap">
                <div class="list-feature">
                    <div data-aos="fade-up" data-aos-delay="600" class="item item-01">
                        <div class="front">
                            <p class="title" data-aos="fade-up" data-aos-delay="700"
                                v-html="t('about.feature.item-01.title')"></p>
                        </div>
                        <div class="back">
                            <ul>
                    ...
                    <div data-aos="fade-up" data-aos-delay="800" class="item item-02">
                        <div class="front">
                            <p class="title" data-aos="fade-up" data-aos-delay="900"
                                v-html="t('about.feature.item-02.title')"></p>
                        </div>
                        <div class="back">
                            <ul>
                    ...
                    <div data-aos="fade-up" data-aos-delay="1000" class="item item-03">
                        <div class="front">
                            <p class="title" data-aos="fade-up" data-aos-delay="1100"
                                v-html="t('about.feature.item-03.title')"></p>
                        </div>
                        <div class="back">
                            <ul>
            ...
            <div class="wrap">
                ...
                <div class="history-timeline">
                    <div class="history-year">
                        <ul>
                            <li v-for="(year, index) in historyItems" :key="year.year" :class="{ active: index === 0 }"
                                data-aos="fade-up" :data-aos-delay="350 + index * 50">
                        ...
                        <li v-for="year in historyItems" :key="`content-${year.year}`">
                            <ul>
                                <li v-for="month in year.months" :key="`${year.year}-${month.label}`" class="month">
                                    ...
                                    <ul>
                                        <li v-for="(item, index) in month.items" :key="`${month.label}-${index}`"
                                            class="item" v-html="localized(item)"></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
