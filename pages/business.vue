            ...
            <div class="list-solution">
                <div class="item" data-aos="fade-up" data-aos-delay="340" @click="openModal('solution', 'aps')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.aps.thumbnail') || '/assets/images/solution/aps.webp'"
                            :alt="t('business.solutions.aps.thumbnail.alt') || 'APS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="420" @click="openModal('solution', 'oms')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.oms.thumbnail') || '/assets/images/solution/oms.webp'"
                            :alt="t('business.solutions.oms.thumbnail.alt') || 'OMS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="560" @click="openModal('solution', 'fems')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.fems.thumbnail') || '/assets/images/solution/fems.webp'"
                            :alt="t('business.solutions.fems.thumbnail.alt') || 'FEMS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="600" @click="openModal('solution', 'scm')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.scm.thumbnail') || '/assets/images/solution/scm.webp'"
                            :alt="t('business.solutions.scm.thumbnail.alt') || 'SCM 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="600" @click="openModal('solution', 'crm')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.crm.thumbnail') || '/assets/images/solution/crm.webp'"
                            :alt="t('business.solutions.crm.thumbnail.alt') || 'CRM 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="600" @click="openModal('solution', 'mes')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.mes.thumbnail') || '/assets/images/solution/mes.webp'"
                            :alt="t('business.solutions.mes.thumbnail.alt') || 'MES 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="600" @click="openModal('solution', 'wcs')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.wcs.thumbnail') || '/assets/images/solution/wcs.webp'"
                            :alt="t('business.solutions.wcs.thumbnail.alt') || 'WCS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="600" @click="openModal('solution', 'tms')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.tms.thumbnail') || '/assets/images/solution/tms.webp'"
                            :alt="t('business.solutions.tms.thumbnail.alt') || 'TMS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="580" @click="openModal('solution', 'ai')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.ai.thumbnail') || '/assets/images/solution/ai.webp'"
                            :alt="t('business.solutions.ai.thumbnail.alt') || 'AI 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
                ...
                <div class="item" data-aos="fade-up" data-aos-delay="500" @click="openModal('solution', 'wms')">
                    <div class="thumbnail">
                        ...
                        <img
                            :src="t('business.solutions.wms.thumbnail') || '/assets/images/solution/wms.webp'"
                            :alt="t('business.solutions.wms.thumbnail.alt') || 'WMS 솔루션의 썸네일 이미지입니다.'"
                        />
                    </div>
                    <div class="content">
    ...
    <div class="modal" :class="{ active: isModal('solution', 'aps') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.aps.modal.src') || '/assets/images/modal/solution/aps.webp'"
                        :alt="t('business.solutions.aps.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'oms') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.oms.modal.src') || '/assets/images/modal/solution/oms.webp'"
                        :alt="t('business.solutions.oms.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'fems') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.fems.modal.src') || '/assets/images/modal/solution/fems.webp'"
                        :alt="t('business.solutions.fems.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'scm') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.scm.modal.src') || '/assets/images/modal/solution/scm.webp'"
                        :alt="t('business.solutions.scm.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'crm') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.crm.modal.src') || '/assets/images/modal/solution/crm.webp'"
                        :alt="t('business.solutions.crm.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'mes') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.mes.modal.src') || '/assets/images/modal/solution/mes.webp'"
                        :alt="t('business.solutions.mes.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'wcs') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.wcs.modal.src') || '/assets/images/modal/solution/wcs.webp'"
                        :alt="t('business.solutions.wcs.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'tms') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.tms.modal.src') || '/assets/images/modal/solution/tms.webp'"
                        :alt="t('business.solutions.tms.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'ai') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.ai.modal.src') || '/assets/images/modal/solution/ai.webp'"
                        :alt="t('business.solutions.ai.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('solution', 'wms') }" @click.self="closeModal">
        <div class="modal-content content-solution">
            ...
            <div class="modal-body">
                ...
                <div class="content">
                    <img
                        :src="t('business.solutions.wms.modal.src') || '/assets/images/modal/solution/wms.webp'"
                        :alt="t('business.solutions.wms.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('success', 'tailim') }" @click.self="closeModal">
        <div class="modal-content content-success">
            ...
            <div class="modal-body">
                <div class="content">
                    <img
                        :src="t('business.success.case1.modal.src') || '/assets/images/modal/success/tailim.webp'"
                        :alt="t('business.success.case1.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
    ...
    <div class="modal" :class="{ active: isModal('success', 'kkleannara') }" @click.self="closeModal">
        <div class="modal-content content-success">
            ...
            <div class="modal-body">
                <div class="content">
                    <img
                        :src="t('business.success.case2.modal.src') || '/assets/images/modal/success/kleannara.webp'"
                        :alt="t('business.success.case2.modal.alt') || ''"
                    />
                </div>
            </div>
        </div>
...
const isModal = (type: string, id: string) => activeModal.value.type === type && activeModal.value.id === id;
