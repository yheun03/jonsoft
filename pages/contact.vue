...
<section ref="root" class="legacy-section-root">
    <div class="navigator">
        <div class="tab">
            <ul>
                <li class="active" data-aos="fade-up" data-aos-delay="100" @click="scrollToSection('location')"><a href="javascript:void(0)" v-html="t('contact.tab.location')"></a></li>
                <li data-aos="fade-up" data-aos-delay="180" @click="scrollToSection('recruit')"><a href="javascript:void(0)" v-html="t('contact.tab.recruitment')"></a></li>
            </ul>
        </div>
        <div class="tab-content">
            <div id="contact-location" ref="locationSection" class="contact">
                <div class="wrap not-padding">
                    ...
                    <div class="info">
                        ...
                        <dl>
                            ...
                            <dd>
                                <span data-aos="fade-up" data-aos-delay="560"><strong v-html="t('contact.contact.sales.grade')"></strong> <span v-html="t('contact.contact.sales.name')"></span></span>
                                <a data-aos="fade-up" data-aos-delay="580" href="mailto:js.jung@jonsoft.co.kr?subject=입사를 희망합니다.&body=안녕하세요, 지원자 김조앤입니다.%0D%0A%0D%0A지원서와 함께 메일 송부드립니다.">js.jung@jonsoft.co.kr</a>
                            </dd>
                            <dd>
                                <span data-aos="fade-up" data-aos-delay="600"><strong v-html="t('contact.contact.manager.team')"></strong> <span v-html="t('contact.contact.manager.name')"></span></span>
                                <a data-aos="fade-up" data-aos-delay="600" href="mailto:hk.kim@jonsoft.co.kr?subject=입사를 희망합니다.&body=안녕하세요, 지원자 김조앤입니다.%0D%0A%0D%0A지원서와 함께 메일 송부드립니다.">hk.kim@jonsoft.co.kr</a>
                            </dd>
                        </dl>
                    </div>
                </div>
                <div class="list-map">
                    <div class="item">
                        <div id="daumRoughmapContainer1693978036661" class="root_daum_roughmap root_daum_roughmap_landing" data-aos="fade-up" data-aos-delay="600"></div>
                        <div class="wrap full">
                            <ul>
        ...
        <div class="tab">
            <ul>
                <li data-aos="fade-up" data-aos-delay="100" @click="scrollToSection('location')"><a href="javascript:void(0)" v-html="t('contact.tab.location')"></a></li>
                <li class="active" data-aos="fade-up" data-aos-delay="180" @click="scrollToSection('recruit')"><a href="javascript:void(0)" v-html="t('contact.tab.recruitment')"></a></li>
            </ul>
        </div>
        <div class="tab-content">
                ...
                <div class="wrap not-padding">
                    ...
                    <div class="info">
                        ...
                        <p>
                            ...
                            <span data-aos="fade-up" data-aos-delay="600"><span v-html="t('contact.contact.manager.name')"></span> <span v-html="t('contact.contact.manager.grade')"></span></span>
                            <a data-aos="fade-up" data-aos-delay="600" href="mailto:hk.kim@jonsoft.co.kr?subject=입사를 희망합니다.&body=안녕하세요, 지원자 김조앤입니다.%0D%0A%0D%0A지원서와 함께 메일 송부드립니다.">hk.kim@jonsoft.co.kr</a>
                        </p>
                    </div>
                </div>
