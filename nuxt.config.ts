        ...
        head: {
            ...
            link: [
                ...
                },
                {
                    ...
                    sizes: '180x180',
                    href: sitePath('/assets/icons/favicon/apple-touch-icon.webp'),
                },
                {
                    rel: 'icon',
                    type: 'image/webp',
                    sizes: '32x32',
                    href: sitePath('/assets/icons/favicon/favicon-32x32.webp'),
                },
                {
                    rel: 'icon',
                    type: 'image/webp',
                    sizes: '16x16',
                    href: sitePath('/assets/icons/favicon/favicon-16x16.webp'),
                },
            ],
        },
    },
