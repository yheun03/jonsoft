...
<section>
    ...
    <div class="module-text">
        <div class="wrap">
            <p class="title-sub" data-aos="fade-up" data-aos-delay="200"><span class="gradient-text" data-i18n="business.module-text.overview.title-sub">솔루션</span></p>
            <p class="title" data-aos="fade-up" data-aos-delay="400" data-i18n="business.module-text.overview.title">조앤소프트는 주문관리시스템(OMS), 생산관리시스템(MES), 공장에너지관리시스템(FEMS), 고객관계관리(CRM), 공급망관리(SCM), 생산계획시스템(APS), 창고제어시스템(WCS), 자동배차관리시스템(TMS) 및 AI솔루션(work@AI)</p>
            <p class="dscpt" data-aos="fade-up" data-aos-delay="600" data-i18n="business.module-text.overview.dscpt">그 밖에 PLM, WMS, ESG 생태계공장, DPP, 빅데이터 분석 / 모니터링 시스템 등 다양한 고객 맞춤형 솔루션을 보유하고 있습니다.</p>
        </div>
    </div>
    <div class="solution">
        <div class="list-solution">
            <div class="item" data-aos="fade-up" data-aos-delay="800" data-modal-target="aps" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.aps.dscpt">다품종 소량생산 제조기업의 까다로운 생산계획수립 업무를 거래처 납품일, 설비의 생산Capa, 생산공정의 흐름에 따라 자동 생산계획을 수립하고 현장 POP시스템을 통해 Paperless 환경의 생산지시를 수행합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="1000" data-modal-target="oms" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.oms.dscpt">OMS는 Fax, 이메일 등 기존 아날로그 주문서를 수신하여 매일 반복하여 입력하는 업무를 OCR과 AI 기술을 활용하여 신속하게 처리하고 휴먼 리소스의 업무를 혁신적으로 줄입니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="1400" data-modal-target="fems" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.fems.dscpt">공장의 에너지 측정, 모니터링, 분석, 제어 등을 통해 에너지 소비를 최적화하고, AI 수요 예측 모델을 통해 효율적으로 에너지를 관리하는 시스템입니다. 특히, 정격용량 대비 에너지 소모량이 많은 설비를 추적하여 설비의 예지보전 업무를 신속하게 처리하도록 지원합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="1800" data-modal-target="scm" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.scm.dscpt">제조협력 기업간 상생형 공급망을 구축하여 수주, 발주, 생산진행현황, 출고, 납품정보를 리얼타임으로 제공합니다. 기업간 데이터의 표준화와 정보의 적시 전달을 통해 불필요한 커뮤니케이션을 줄이고 Total Lead Time을 줄입니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="2200" data-modal-target="crm" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.crm.dscpt">영업조직의 목표와 실적관리, 신규영업기회 관리, 영업활동관리, 견적/제안 관리, 계약관리, 매출관리를 손쉽게 처리하고 모바일 APP과 연동하여 영업활동을 간편하게 지원합니다. 특히 영업보고서를 시스템에서 자동 생성합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="2400" data-modal-target="mes" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.mes.dscpt">수주에서 자재발주, 입고, 출고, 생산지시, 생산 공정관리, 품질 관리업무를 수행하고, 수작업 기반의 생산현장 업무를 키오스크, 바코드 /QR코드, 태블릿 기기를 활용하여 Paperless 환경으로 스마트한 현장 관리가 가능합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="2000" data-modal-target="wcs" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.wcs.dscpt">무인 운반 로봇을 활용하여 생산공정과 물류창고간 제품 이동, 생산공정간 반제품 이동 업무를 MES/WMS 시스템과 연동하여 로봇의 작업계획을 수립하고 RCS를 통해 Bot을 컨트롤 합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="2000" data-modal-target="tms" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.tms.dscpt">ERP/WMS시스템과 연계하여 납품요청을 기반으로 적재해야 할 제품의 부피와 차량의 적재 Capa 에 맞춰 매칭하여 자동 배차합니다. 상차 후 키오스크를 활용하여 셀프 거래명세표 인쇄 등으로 불필요한 전표관리 업무를 없애고 운송비용을 줄여줍니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="1600" data-modal-target="ai" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.ai.dscpt">현장의 다양한 데이터를 기반으로 예측과 자동화를 실현하여 운영 효율을 높이고, 핵심 시스템과 유연하게 연동되며, 지속적인 개선을 통해 확장 가능한 AI 환경을 제공합니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
            <div class="item" data-aos="fade-up" data-aos-delay="1200" data-modal-target="wms" data-modal-type="solution">
                ...
                <div class="content">
                    ...
                    <p data-i18n="business.solutions.wms.dscpt">RFID,QR, Barcode 를 활용하여 원자재 및 제품의 Life Cycle을 스마트하게 관리합니다. 선입선출(FIFO) 방식으로 자재 입고와 생산 불출 처리를 지원하고 로케이션 기반의 상품 입고, 출고를 통해 창고관리 업무 효율을 높입니다.</p>
                    <a href="#"><span data-i18n="business.solutions.button">자세히 보기</span></a>
                </div>
            </div>
        </div>
    ...
    <div class="success" id="success">
        <div class="wrap">
            <h3 data-i18n="business.success.title" data-aos="fade-up" data-aos-delay="200">Success Case</h3>
            <ul class="list-case">
                <li class="item" data-aos="fade-up" data-aos-delay="400" data-modal-target="tailim" data-modal-type="success">
                    <div class="content">
                        <p class="title" data-i18n="business.success.case1.title">스마트앱을 통해<br/>업무를 간편하게</p>
                        <ul class="dscpt" data-i18n="business.success.case1.dscpt">
                            <li>모바일 발주 시스템</li>
                            <li>안드로이드/IOS 앱</li>
                        </ul>
                    </div>
                ...
                <li class="item" data-aos="fade-up" data-aos-delay="600" data-modal-target="kkleannara" data-modal-type="success">
                    <div class="content">
                        <p class="title" data-i18n="business.success.case2.title">재고조회도,<br/>주문도 더 빠르게</p>
                        <ul class="dscpt" data-i18n="business.success.case2.dscpt">
                            <li>KN-OMS</li>
                            <li>웹 모바일 주문 관리 시스템</li>
                            <li>안드로이드/IOS 앱</li>
                        </ul>
                    </div>
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="aps" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.aps.title">APS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.aps.subTitle">Advanced Planning and Scheduling</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.aps.badge">생산계획시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
            <div class="abstract">
                <p data-i18n="business.solutions.aps.modal.abstract">조앤소프트 APS는 AI및 최적화 기술을 적용한 경험을 바탕으로 구현한 최적화 생산계획 및 스케줄링 솔루션으로 공정간 재공 밸런스를 고려하여 적량 적시 생산을 달성하므로 제조 비용을 크게 절감시키는 솔루션입니다.</p>
            </div>
            <div class="title">
                <span data-i18n="business.solutions.aps.modal.screen.title">주요화면</span>
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="oms" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.oms.title">OMS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.oms.subTitle">Order Management System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.oms.badge">주문관리시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="fems" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.fems.title">FEMS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.fems.subTitle">Factory Energy Management System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.fems.badge">공장에너지관리시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="scm" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.scm.title">SCM 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.scm.subTitle">Supply Chain Management</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.scm.badge">공급망관리</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="crm" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.crm.title">CRM 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.crm.subTitle">Customer Relationship Management</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.crm.badge">고객관계관리</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
            <div class="abstract">
                <p data-i18n="business.solutions.crm.modal.abstract">조앤소프트 CRM은 고객 데이터를 기반으로 고객의 행동을 예측하고, 맞춤형 마케팅 및 고객 서비스 전략을 실행할 수 있도록 돕는 강력한 고객관계관리 플랫폼입니다.중소기업부터 대기업까지 다양한 규모의 기업을 위한 CRM솔루션을 제공하며, 효율적이고 직관적인 사용자 경험을 제공합니다.</p>
            </div>
            <div class="title">
                <span data-i18n="business.solutions.crm.modal.screen.title">주요화면</span>
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="mes" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.mes.title">MES 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.mes.subTitle">Manufacturing Execution System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.mes.badge">고객관계관리</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="wcs" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.wcs.title">WCS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.wcs.subTitle">Warehouse Control System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.wcs.badge">창고제어시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
            <div class="abstract">
                <p data-i18n="business.solutions.wcs.modal.abstract">조앤소프트 WCS는 실시간으로 장비를 제어하고 라우팅 및 물류창고 운영을 최적화하여 상품이 원활하고 효율적으로 이동하도록 하는 것으로 자동 컨베이어, 분류 시스템, 자동창고(AS/RS), 로봇 시스템과 같은 장치와 직접적으로 상호 작용하는 솔루션입니다.</p>
            </div>
            <div class="title">
                <span data-i18n="business.solutions.wcs.modal.screen.title">주요화면</span>
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="tms" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.tms.title">TMS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.tms.subTitle">Transport Management System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.tms.badge">자동배차관리시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="ai" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.ai.title">AI 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.ai.subTitle">Advanced Technology AI Platform</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.ai.badge">work@AI</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-solution" data-modal-id="wms" data-modal-type="solution">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.solutions.wms.title">WMS 솔루션</p>
                <p class="title-sub" data-i18n="business.solutions.wms.subTitle">Warehouse Management System</p>
            </div>
            <ul>
                <li data-i18n="business.solutions.wms.badge">창고관리시스템</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
        </div>
        <div class="modal-body">
...
<div class="modal">
    <div class="modal-content content-success" data-modal-id="tailim" data-modal-type="success">
        <div class="modal-header">
            <div class="heading">
                <p class="title" data-i18n="business.success.case1.title">이제는 업무도<br/>스마트하게</p>
            </div>
            <ul data-i18n="business.success.case1.dscpt">
                <li>모바일 발주 시스템</li>
                <li>안드로이드/iOS 앱</li>
            </ul>
            <a href="" class="btn type-round">닫기</a>
...
<div class="modal">
    <div class="modal-content content-success" data-modal-id="kkleannara" data-modal-type="success">
        <div class="modal-header">
            ...
            <ul data-i18n="business.success.case2.dscpt">
                <li>KN-OMS</li>
                <li>웹 모바일 주문 관리 시스템</li>
                <li>안드로이드/IOS 앱</li>
            </ul>
...
useLegacySectionRoot(root, getI18nNamespaces('/business'))
</script>
